...
augroup haskellMaps
  ...
  autocmd FileType haskell setlocal g:haskell_indent_disable=1

  " let g:haskell_indent_disable = 1

  autocmd FileType haskell setlocal hindent_on_save=0
  autocmd FileType haskell setlocal hindent_indent_size=4
